...
export const fonts = {
  ...
  body: 'Poppins_500Medium',      // was 400Regular — bumped for on-site sunlight legibility
  bodyLight: 'Poppins_400Regular',
...
const dark = {
  ...
  ink: '#F7F3EA',
  ink2: 'rgba(247,243,234,0.80)',
  ink3: 'rgba(247,243,234,0.56)',
...
const light = {
  ...
  ink: '#221F3A',
  ink2: 'rgba(34,31,58,0.80)',
  ink3: 'rgba(34,31,58,0.58)',
  accent: palette.accent,
  accent2: palette.accent2,
  hot: brand.coral,
